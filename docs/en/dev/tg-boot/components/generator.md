---
title: spring-boot-starter-generator (removed)
...
本仓库定位已明确为 **面向 AI 助手与开发者的模块化单体**：请按 [TG-boot 总览](/en/dev/tg-boot/) 中的架构与命名约定，由 AI 或开发者**从表结构设计 → API 契约 → `*-biz` 实现**直接编写代码。

生成代码前请先阅读 [AI 编码规范](/en/dev/tg-boot/agents/)。
